...
def kuka_IK(point, R, joint_positions):
    ...
    iters = 0
    while np.linalg.norm(Epsilon_x) > threshold and iters < max_iters:
        iters += 1
...
def forward_kinematics(q):
    ...
    DH_params.append([np.pi/2, 0.311, 0, q1])
